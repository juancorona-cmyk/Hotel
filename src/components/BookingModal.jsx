...
export default function BookingModal({ initialRoom, onClose, promoActive = false, promoConfig = { label: '20% OFF', color: '#b5c840' } }) {
  ...
  const handleSubmit = (e) => {
    ...
    trackEvent('reserva_confirmada', { source: 'booking_modal', origin: 'web', ...(promoActive ? { promo: 'web_20' } : {}), folio, room: roomId, nights, adults, children, rooms, checkin, checkout, device: getDeviceType() })
