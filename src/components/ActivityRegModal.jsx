      ...
      <div className="arm-card">
        ...
        {reg.restoring ? (
          ...
          <div className="arm-pend">
            ...
            {reg.proofUploaded ? (
              ...
              <div className="arm-pend__upload">
                <label className={`arm-pend__dropzone${reg.uploadingProof ? ' arm-pend__dropzone--loading' : ''}`}>
                  {reg.uploadingProof ? (
                    <>
                      <svg className="arm-pend__upload-spin" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#5a6c1e" strokeWidth="2.5"><line x1="12" y1="2" x2="12" y2="6"/><line x1="12" y1="18" x2="12" y2="22"/><line x1="4.93" y1="4.93" x2="7.76" y2="7.76"/><line x1="16.24" y1="16.24" x2="19.07" y2="19.07"/><line x1="2" y1="12" x2="6" y2="12"/><line x1="18" y1="12" x2="22" y2="12"/><line x1="4.93" y1="19.07" x2="7.76" y2="16.24"/><line x1="16.24" y1="7.76" x2="19.07" y2="4.93"/></svg>
                      <span className="arm-pend__dropzone-main">Subiendo comprobante…</span>
                    </>
                  ) : (
                    <>
                      <div className="arm-pend__dropzone-icon">
                      ...
                      <span className="arm-pend__dropzone-main">Adjunta tu comprobante</span>
                      <span className="arm-pend__dropzone-sub">Imagen o PDF · Toca para seleccionar</span>
                    </>
                  )}
            ...
            {reg.proofUploaded && reg.whatsapp === 'Sí' && (
              <a className="arm-success__btn-group" href="https://chat.whatsapp.com/GVefjT90VZRJZ9X18Vizaw" target="_blank" rel="noopener noreferrer">
          ...
          <div className="arm-success">
            ...
            <div className="arm-success__actions">
              ...
              >
                <span className="arm-success__btn-icon">
                  {reg.downloadingPDF
                    ...
                    : <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3v13"/><polyline points="8 12 12 16 16 12"/><path d="M4 19h16"/></svg>
                  }
                </span>
              ...
              {/* WhatsApp fila — uno o dos botones lado a lado */}
              <div className="arm-success__wa-row">
                <button 
                  className="arm-success__wa-btn arm-success__wa-btn--ticket arm-success__wa-btn--disabled" 
                  onClick={reg.handleSendTicketWhatsApp}
                  disabled
                  style={{ background: '#bbbbbb', opacity: 0.7, cursor: 'not-allowed', pointerEvents: 'none', border: 'none' }}
                >
                  <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                  Recibir ticket (Próximamente)
                </button>
                <p style={{ fontSize: '10px', color: '#888', textAlign: 'center', marginTop: '4px', width: '100%' }}>Próximamente disponible</p>
                {reg.whatsapp === 'Sí' && (
                  <button type="button" className="arm-success__wa-btn arm-success__wa-btn--group" onClick={reg.handleJoinGroup}>
                    <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                    Unirme al grupo
                  </button>
                )}
            ...
            {reg.duplicateReg ? (
              <>
                <div className="arm-duplicate-notice">
                  <span className="arm-duplicate-icon">✓</span>
                  <div>
                    <p className="arm-duplicate-title">Ya tienes un registro para este evento</p>
                    <p className="arm-duplicate-sub">{reg.duplicateReg.full_name} · #{String(reg.duplicateReg.id).padStart(4, '0')}</p>
                  </div>
                </div>
