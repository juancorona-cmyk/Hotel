                ...
                <div className="ep-pend">
                  ...
                  {reg.proofUploaded ? (
                    <>
                      ...
                      {reg.whatsapp === 'Sí' && (
                        <a className="ep-group-btn" href="https://chat.whatsapp.com/GVefjT90VZRJZ9X18Vizaw" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="ep-pend__upload">
                      ...
                      {reg.proofError && <p className="ep-pend__upload-error">{reg.proofError}</p>}
                    </div>
                  )}
                    ...
                    {reg.registrationId && (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', flex: 1 }}>
                        ...
                        >
                          ...
                          Recibir por WhatsApp (Próximamente)
                        </button>
                        <p style={{ fontSize: '10px', color: '#888', textAlign: 'center' }}>Próximamente disponible</p>
                      </div>
                    )}
                    {reg.whatsapp === 'Sí' && (
                      <button
                    ...
                    {reg.duplicateReg ? (
                      <>
                        <div className="ep-duplicate-notice">
                          <span className="ep-duplicate-icon">✓</span>
                          <div>
                            <p className="ep-duplicate-title">Ya tienes un registro para este evento</p>
                            <p className="ep-duplicate-sub">{reg.duplicateReg.full_name} · #{String(reg.duplicateReg.id).padStart(4, '0')}</p>
                          </div>
                        </div>
